package com.anhuay.common.aspect;
...
import com.anhuay.common.dao.LogDao;
import com.anhuay.common.domain.LogDO;
import com.anhuay.common.utils.HttpContextUtils;
import com.anhuay.common.utils.IPUtils;
import com.anhuay.common.utils.JSONUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.anhuay.common.annotation.Log)")
    ...
    void saveLog(ProceedingJoinPoint joinPoint, long time) throws InterruptedException {
        ...
        try {
            String params = JSONUtils.beanToJson(args[0]).substring(0, 3708);
