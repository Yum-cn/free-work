...
public class UpgradeTaskDO implements Serializable {
	 ...
	 * 设置：终端程序编号
	 */
	public void setTerminalFileId(Long terminalFileId) {
	 ...
	 * 设置：终端程序下载地址
	 */
	public void setTerminalFileDownloadUrl(String terminalFileDownloadUrl) {
		this.terminalFileDownloadUrl = terminalFileDownloadUrl;
	}
	/**
	 * 获取：终端程序下载地址
	 */
	public String getTerminalFileDownloadUrl() {
		return terminalFileDownloadUrl;
	}
	/**
	 * 设置：升级任务名称
	 */
